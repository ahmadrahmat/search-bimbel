...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2019 at 12:34 PM
...
(2, 'digitalks', 'CV. Digitalks Cendana Solution', '2770faa5d3cf5540313dd30d788f9d138bf17fe0', 'digitalks@gmail.com', '0852xxxxxxxx', 'Jl. Cendana', 129, 2),
...
(4, 'nurgianto', 'Nurgianto', '7a6ca6cc9a924543efe0cb17acc264361e386af5', 'nurgianto@gmail.com', '-', '-', 129, 4),
(5, 'harto', 'Muh. Harto Sulila', '17aa45f892c5baadb11dc0e2190a1fd2eba8c79b', 'harto@gmail.com', '-', '-', 129, 3),
(6, 'gg', 'CV. GG.BET', 'f3226f91f77a87d909b8920adc91f9a301a7316b', 'gg@bet.com', '-', '-', 129, 2),
(7, 'mufida', 'CV. Mufida Terminal Print', 'ec37b3141185194dfc4c362414fd33fb38322962', 'mufida@gmail.com', '0823232323', 'Jl. Muka Kampus UNG', 130, 2);
...
INSERT INTO `enrollment` (`id`, `start_date`, `end_date`, `start_time`, `duration`, `num_of_meeting`, `phone`, `note`, `student_id`, `subject_id`, `status`) VALUES
(2, '2019-12-18', '2019-12-31', '10:00', '2', 7, '-', '-', 1, 1, 1),
(3, '2019-12-20', '2019-12-31', '08.00', '2', 7, '-', '-', 1, 3, 0);
...
INSERT INTO `job_application` (`id`, `approved`, `organization_id`, `tutor_id`) VALUES
(1, 0, 1, 1),
(2, 1, 3, 1);
...
INSERT INTO `organization` (`id`, `name`, `phone`, `address`, `city_id`, `payment`, `owner_id`, `activated`) VALUES
(1, 'CV. Digitalks Cendana Solution', '0852xxxxxxxx', 'Jl. Cendana', 129, 500000, 1, 1),
(2, 'CV. GG.BET', '-', '-', 129, NULL, 2, 1),
(3, 'Brillian Brain', '0823232323', 'Jl. Muka Kampus UNG', 130, 250000, 3, 1);
...
INSERT INTO `subject` (`id`, `name`, `description`, `subject_type_id`, `organization_id`, `tutor_id`) VALUES
(1, 'Belajar Pantun', 'Memahami apa itu pantun', 1, 1, 2),
(2, 'Matematika Dasar', '-', 2, 2, NULL),
(3, 'Matematika', 'Belajar Matematika', 3, 3, 2),
(4, 'Matematika', 'Lulus UN Matematika', 4, 3, NULL);

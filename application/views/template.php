...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			">
				...
				<div id="collapseDM" class="collapse
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item <?= $this->uri->segment(1) == 'job' ? 'active' : '' ?>" href="<?= site_url('job') ?>">Job</a>
			...
			<?php if ($this->fungsi->user_login()->bimbel_user_type_id == 2) : ?>
			<!-- Nav Item -->
			<li class="nav-item <?= $this->uri->segment(1) == 'controller_owner' ? 'active' : '' ?>">
				<a class="nav-link" href="<?= site_url('controller_owner') ?>">

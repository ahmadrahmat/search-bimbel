            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">My Account</a>  /  <span class="text-success">Sent</span></p>
                  </div>
               </div>
            </div>
         </div>
					...
					<div class="card-body p-0">
						<ul class="nav nav-pills flex-column">
							<li class="nav-item <?= $this->uri->segment(1) == 'email' ? 'active' : '' ?>">
								<a href="<?= site_url('home/email') ?>" class="nav-link <?= $this->uri->segment(2) == '' ? 'active' : '' ?>">
									<i class="fas fa-inbox"></i> Inbox
								</a>
							</li>
							<li class="nav-item">
								<a href="<?= site_url('home/sent') ?>" class="nav-link <?= $this->uri->segment(2) == 'sent' ? 'active' : '' ?>">
							...
							<table class="table table-hover table-striped" id="dataTable">
								...
								<?php $no=1; foreach ($row->result() as $key => $data) : ?>
										...
										<td class="mailbox-number"><?= $no++; ?></td>
											<td class="mailbox-name"><a href="<?= site_url('home/read_sent/' . $data->id) ?>" style='color: black;'><?= $data->bimbel_user_name ?></a></td>

            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">My Account</a>  /  <span class="text-success">Read Sent</span></p>
                  </div>
               </div>
            </div>
         </div>
				...
				<div class="card">
					...
					<div class="card-body p-0">
						<ul class="nav nav-pills flex-column">
							...
							<li class="nav-item">
								<a href="<?= site_url('home/sent') ?>" class="nav-link <?= $this->uri->segment(2) == 'read_sent' ? 'active' : '' ?>">

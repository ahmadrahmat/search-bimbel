            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">My Account</a>  /  <span class="text-success">Compose Mail</span></p>
                  </div>
               </div>
            </div>
         </div>
				...
				<div class="card">
					...
					<div class="card-body p-0">
						<ul class="nav nav-pills flex-column">
							<li class="nav-item <?= $this->uri->segment(2) == 'compose' ? 'active' : '' ?>">
								<a href="<?= site_url('home/email') ?>" class="nav-link <?= $this->uri->segment(2) == 'compose' ? 'active' : '' ?>">

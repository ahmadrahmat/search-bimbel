         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h1 class="mt-0 mb-3 text-white">About</h1>
                  <div class="breadcrumbs">
                     <!-- <p class="mb-0 text-white"><a class="text-white" href="#">About</a>  /  <span class="text-success">About Us</span></p> -->
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="pl-4 col-lg-5 col-md-5 pr-4">
                  <img class="rounded img-fluid" src="<?php echo base_url(); ?>assets/frontend/img/about.jpg" alt="Card image cap">
               </div>
